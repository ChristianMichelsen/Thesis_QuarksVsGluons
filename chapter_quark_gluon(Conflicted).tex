...
\end{equation}
This is visualized in Figure~\ref{fig:q:logloss}. Here it can be seen how the loss changes as a function of the prediction score. Notice that when $y=0$ the loss is undefined for $\hat{y}=1$ and likewise with $y=1$ and $\hat{y}=0$ (since $\log 0$ is undefined).
