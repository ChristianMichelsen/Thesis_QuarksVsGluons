...
\begin{marginfigure}
  \includegraphics[width=0.8\textwidth]{figures/ridge_lasso_sparse/ridge.pdf}
...
\end{marginfigure}
\begin{marginfigure}
  \includegraphics[width=0.8\textwidth]{figures/ridge_lasso_sparse/lasso.pdf}
...
As can be seen from the above discussion, choosing the right value for the regularization strength is fundamental problem in model  How to choose a suitable value for $\lambda$ is discussed in the next two subsections. 
