...
\begin{figure}[h!]
  \includegraphics[draft=false, width=0.9\textwidth]{figures/housing/Villa_v18_cut_all_Ncols_all_prophet_forecast.png}
...
\begin{figure}[h!]
  \includegraphics[draft=false, width=0.9\textwidth]{figures/housing/Villa_v18_cut_all_Ncols_all_prophet_trends.pdf}
