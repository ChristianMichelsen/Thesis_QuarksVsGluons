...
\begin{marginfigure}
  \includegraphics[width=0.7\textwidth]{figures/cross_validation/kfold.pdf}
...
\begin{marginfigure}
  \includegraphics[width=0.7\textwidth]{figures/cross_validation/kfold_time.pdf}
...
\begin{figure}
  ...
  \caption[Comparison of different objective functions.]
    ...
    where $y-\hat{y}<2$ see \figref{fig:ml:objective_funcs_zoom}. All six grafs are symmetric in $y-\hat{y}$ which is why they are only shown for positive values of $y-\hat{y}$.
    }
