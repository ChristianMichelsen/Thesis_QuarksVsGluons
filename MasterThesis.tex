...
\newpage
\begin{figure*}
  \includegraphics[width=0.99\textwidth, trim=30 30 30 70, clip]{figures/quarks/viz_UMAP_test_0.5_input2b_njet=4_algorithm=UMAP.pdf}
  \caption[UMAP Parameter Grid Seach]
          {Grid search of the two parameters \code{n_neighbors} and \code{min_dist} for the UMAP algorithm. For an explanation of these, see \autoref{sec:q:EDA}.} 
