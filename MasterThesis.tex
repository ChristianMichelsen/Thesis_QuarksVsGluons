...
If one takes a look at the time development of the Danish housing\sidenote[][1cm]{\q{Housing} means both actual houses and privately owned apartments in this project.} market, the Danish governmental organization for statistics, Statistics Denmark, releases a price index \citep{dstPriceIndexEJ14} for both one-family houses and owner-occupied apartments quarterly, this is shown in Figure~\ref{fig:h:price_index}. Here it is easy to see the effect of the financial crisis around 2008, but also the steady increase in the housing market since then in both Copenhagen and the entire country. 
...
the distribution of the type of sale \code{SagtypeNr} in subfigure~\subref{fig:h:variable_overview_type},
...
\begin{figure*}
  ...
  \caption[Distributions for the housing price dataset]{Distributions of four out of the 168 input variables. 
           ...
           Subplot ~\protect\subref{fig:h:variable_overview_type} shows the type of sale,
...
The distribution of the date of sale, Figure~\ref{fig:h:variable_overview} \subref{fig:h:variable_overview_date}, is an interesting variable because it shows how Boligsiden has been collecting more and more data over time. Here 2007 and 2019 are clear outliers since their current database only contains sales from the end of 2007, and 2019 only contains data from the first eight months of the year. The type of sale is a discrete code that Boligsiden uses to differentiate between different types of sales. The mapping between code and description can be seen in Table~\ref{tab:h:salgstype}. 
...
In this project only single-family houses -- \q{Villas} in Danish -- with code \num{100} and owner-occupied apartments -- \q{Ejerlejlighed} in Danish -- with code 300 are considered. As can be seen from Figure~\ref{fig:h:variable_overview} \subref{fig:h:variable_overview_type} these two types of sales are also the most frequent sales with close to \num{400000} and \num{150000} sales in total. The longitude distribution, Figure~\ref{fig:h:variable_overview} \subref{fig:h:variable_overview_longitude}, is mostly interesting due to fact that it clearly shows how the Great Belt and especially the Baltic Sea separates Denmark into three parts; the Western part, the Eastern part, and then Bornholm. Note that more than \SI{5}{\percent} of the residences are unknown values: Not a Number \q{NaNs}. The distribution of the area, Figure~\ref{fig:h:variable_overview} \subref{fig:h:variable_overview_area}, shows that most residences are between \SI{50}{\meter^2} and \SI{150}{\meter^2}, as expected. However, a relatively large part of the residences, \SI{2.5}{\percent}, are listed as having an area of \SI{0}{\meter^2}.

\begin{figure}
  \includegraphics[width=0.99\textwidth, page=1, trim=15 15 15 15, clip]{figures/housing/overview_fig.pdf}
...
\begin{figure}
  \includegraphics[width=0.99\textwidth, trim=0 0 0 0, clip]{figures/housing/missing_bar.pdf}
...
\begin{figure}
  \includegraphics[width=0.99\textwidth, trim=0 10 0 10, clip]{figures/housing/missing_dendrogram.pdf}
  \caption[Validity Dendrogram]
          {XXXX \TODO.}
  \label{fig:h:nans_dendrogram}
\end{figure}

also see Figure~\ref{fig:h:nans_heatmap}
...
\begin{figure}
  \includegraphics[width=0.9\textwidth]{figures/housing/Ejerlejlighed_v18_cut_all_Ncols_all_prophet_forecast.png}
...
\begin{figure}
  \includegraphics[width=0.9\textwidth]{figures/housing/Ejerlejlighed_v18_cut_all_Ncols_all_prophet_trends.pdf}
...
\begin{figure*}
  \includegraphics[width=0.9\textwidth, trim=10 10 10 10, clip]{figures/housing/missing_heatmap.pdf}
