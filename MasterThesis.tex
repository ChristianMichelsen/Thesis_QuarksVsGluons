...
\documentclass[a4paper, twoside, nobib]{tufte-book} % notoc, justified,marginals=raggedouter
...
% % custom TOC table of contents
% \titlecontents{section}% FIXME
%   [0em] % distance from left margin
%   {\Large\rmfamily\itshape} % above (global formatting of entry)
%   % {\ifnumgreater{\thecontentslabel}{1}{\addvspace{\baselineskip}}{}}
%   {\hspace*{2em}\textcolor{black}{\contentslabel{2em}}} % before w/label (label = ``2.6'')
%   {\hspace*{2em}} % before w/o label
%   {\titlerule*[0.8em]{.}\rmfamily\upshape\contentspage} % filler + page (leaders and page num)
%   [] % after
...
%   {\hspace*{4em}\textcolor{black}{\contentslabel{3em}}} % before w/label (label = ``2.6'')
%   {\hspace*{4em}} % before w/o label
%   {\titlerule*[0.8em]{.}\rmfamily\upshape\contentspage} % filler + page (leaders and page num)
%   [] % after
