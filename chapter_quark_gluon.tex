...
\begin{table}
  ...
  \begin{tabular}{@{}rrrrrr@{}}
    {}    & \multicolumn{1}{c}{$b$} & \multicolumn{1}{c}{$c$} & \multicolumn{1}{c}{$g$} & non-$q$-matched & \multicolumn{1}{c}{$uds$}    \\ 
    \midrule
    2     & \num{2713454} &  \num{944380} &       \num{0} & \num{1509860} & \num{2125900}  \\
    3     & \num{2433878} &  \num{964212} & \num{3365969} & \num{1887613} & \num{2129218}  \\
    4     &  \num{326264} &  \num{156332} & \num{1012198} &  \num{410566} &  \num{336548}  \\
    ...
    Total & \num{5483970} & \num{2070910} & \num{4433012} & \num{3828522} & \num{4604386}  \\
  \end{tabular}
  \caption{Number of jets for MC and MCb.}
  \label{tab:q:flevt_overview}
\end{table}


reft Table~\ref{tab:q:flevt_overview_percent_relative}. in appendix. 
