...
argumentere for at man kan stole på $g$-tagging model da kun lille forskel mellem MC og Data
...
først komme ind på variable used.

Så kigge på effieciency af gtag på de forskellige variable:
