...
\begin{figure*}%
  \centering
  \subfloat{{\includegraphics[draft=false, width=0.42\textwidth]{figures/quarks/leptons_high_g_vs_low_1.png}}}%
  \;
  \subfloat{{\includegraphics[draft=false, width=0.48\textwidth]{figures/quarks/leptons_high_g_vs_low_2.png} }}%
  \vspace{2mm}
  \caption[XXX]{
    XXX.}
