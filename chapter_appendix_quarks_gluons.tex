...
\begin{figure*}[h!]
  ...
  \caption[ROC Curve for $g$\=/Tag in 4-Jet Events]
          {\label{fig:q:roc_gtag_4j_non_appendix}ROC curve of the eight $g$\=/tag models in 4-jet events. First one in dashed black is the ROC curve that you get by random chance. The colors are the same as in Figure \ref{fig:q:gtag_scores_4j} and in the legend also the Region Under the ROC curve (AUC) is shown.} 
\end{figure*}
\vspace{3cm}
